// Sample intern file modified to run node.js and dojo AMd module
...
define({
	...
	loader: {
	    ...
	    packages: [ 'node', { name: 'app', location: 'src/app' }]
	},

	// Non-functional test suite(s) to run
	// Path is relative to root directory
	suites: [ 'src/test/HelloWorld' ],

	// Functional test suite(s) to run in each browser once non-functional tests are completed
	// functionalSuites: [ 'tests/intern-tutorial/tests/functional/index'  ],
...
// 
// Note: node_module is outside the root directory
// node ../node_modules/intern/client.js config=src/test/intern.js 
